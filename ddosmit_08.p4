...
control MyEgress(inout headers hdr,inout metadata meta,inout standard_metadata_t standard_metadata) {
    ...
    apply {
        ...
        hash(meta.sl_ind, HashAlgorithm.crc32, 32w0, {meta.sl_source}, 32w0xffffffff);
        ...
        if(meta.sl_source == meta.sl_read){
            ...
            //if (hdr.ipv4.isValid() && meta.alarm_pktin != 1) {
                ...
                if (standard_metadata.instance_type == NORMAL && meta.recirculated != 1 && meta.features == 1){
                    ...
                    hash(meta.hhd_index, HashAlgorithm.crc32, 32w0, {meta.hhd_key_carried}, 32w0xffffffff);
                    ...
                    if (meta.hhd_swapped == 1){
                        ...
                        hash(meta.hhd_index, HashAlgorithm.crc32_custom, 32w0, {meta.hhd_key_carried}, 32w0xffffffff);
